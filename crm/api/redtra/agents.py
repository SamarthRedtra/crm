...
def _serialize_agent_summary(row: dict[str, Any]) -> dict[str, Any]:
	...
	return {
		...
		"broker_license_status": row.get("dda_broker_license_status") or "Not Checked",
		"broker_license_expiry_date": row.get("dda_broker_license_expiry_date"),
		"agency_match_status": row.get("dda_agency_match_status") or "Unknown",
