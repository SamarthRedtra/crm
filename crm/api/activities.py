...
def get_activities(name):
	...
	elif frappe.db.exists("Property", name):
		return get_property_activities(name)
	else:
		frappe.throw(_("Document not found"), frappe.DoesNotExistError)


def get_property_activities(name):
	return get_document_activities("Property", name, "created this property")
...
def get_document_activities(doctype, name, creation_text):
	get_docinfo("", doctype, name)
	docinfo = frappe.response["docinfo"]
	meta = frappe.get_meta(doctype)
	fields = {
		field.fieldname: {"label": field.label, "options": field.options} for field in meta.fields
	}
